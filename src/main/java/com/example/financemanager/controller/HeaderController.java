...
public class HeaderController {
    ...
    public void showRevenus(ActionEvent actionEvent) throws IOException{
        logger.info("showRevenus called");
        FXMLLoader fxmlLoader = new FXMLLoader(FinanceTrackerApplication.class.getResource("revenu-view.fxml"));
        Stage stage = (Stage) root.getScene().getWindow();
        Scene scene = new Scene(fxmlLoader.load());
        stage.setScene(scene);
        stage.show();
        logger.info("showRevenus end");
    }
}
